      ...
      <div class="row">
        ...
        <div class="col-3">
          ...
          <div class="mb-3">
            ...
            <input name="nome" type="text" autofocus value="<?php echo isset($cidades) ? $cidades['cep']: "" ?>" class="form-control">
          </div>

          <div class="mb-3">
            <label class="form-label"> estado </label>
            <input name="nome" type="text" autofocus value="<?php echo isset($cidades) ? $cidades['estado']: "" ?>" class="form-control">
          </div>

          <div class="mb-3">
            <label class="form-label"> id_regiao_fk </label>
            <input name="nome" type="text" autofocus value="<?php echo isset($cidades) ? $cidades['id_regiao_fk']: "" ?>" class="form-control">
          </div>
